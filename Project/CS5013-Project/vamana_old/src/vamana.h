...
__global__ void computeNeighborDists(uint8_t* d_graph, unsigned* d_neighbors,
                                     unsigned* d_neighborsCount, float* d_queryVecs,
                                     float* d_neighborDists);

__global__ void sortNeighborDists(unsigned* d_neighbors, unsigned* d_neighborsCount,
                                  float* d_neighborsDist, unsigned* d_neighborsAux,
...
__global__ void mergeIntoWorklist(unsigned* d_worklistCount, unsigned* d_worklist,
                                  float* d_worklistDist, unsigned* d_worklistVisited,
...
__global__ void computeVisitedSetDists(uint8_t* d_graph, unsigned* d_visitedSet,
                                       unsigned* d_visitedSetCount, float* d_queryVecs,
                                       float* d_visitedSetDists);

__global__ void sortVisitedSets(unsigned* d_visitedSet, unsigned* d_visitedSetCount,
                                float* d_visitedSetDists, unsigned* d_visitedSetAux,
                                float* d_visitedSetDistsAux);

__global__ void mergeNeighborsIntoVisitedSet(unsigned* d_visitedSetCount, unsigned* d_visitedSet,
                                             float* d_visitedSetDists,
